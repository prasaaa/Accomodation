...
public class Property_INSERT {
	...
	private String property_name,property_price,property_address,property_type,property_avalability;
        ...
        public Property_INSERT(Connection c,String query,String property_name, String property_price, String property_address, String property_type, String property_avalability){
    ...
    public void insert_Property_table() {
